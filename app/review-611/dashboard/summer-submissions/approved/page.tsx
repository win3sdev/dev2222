...
export default function SummerApprovedPage() {
  ...
  const fetchSubmissions = async () => {
    try {
      ...
      const response = await fetch(
        `/api/summer-submissions?status=approved&page=${page}&pageSize=${PAGE_SIZE}`
      );
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">暑期问卷已通过</h1>
      ...
      {submissions.length === 0 ? (
        <div className="text-center py-12">
          <div className="text-gray-500 text-lg">暂无已通过的暑期问卷</div>
        </div>
      ) : (
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="rounded-md bg-orange-500 px-3 py-1 text-white text-sm hover:bg-orange-600 transition-colors"
                        >
                          重新审核
                        </button>
                      </div>
      ...
      {showReviewModal && selectedSubmission && (
        <div className="fixed inset-0  bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4">重新审核暑期问卷</h3>
            <div className="mb-4">
